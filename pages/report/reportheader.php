...
<table style="width: 100%; margin-bottom: 20px; border-collapse: collapse;">
  ...
  <tr>
    <td align="right" style="background-color: green; padding-right: 20px;" height="25%">
      <div style="color: white; font-weight: bold; font-size: x-large;">PT PANCURAN KAAPIT SENDANG</div>
    </td>
    <!-- <td >4</td> -->
