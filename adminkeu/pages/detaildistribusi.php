...
if (isset($_GET['id'])) {
  ...
  $array1 = array_filter(array((float)$row['lat1'], (float)$row['lng1'], $row['distro1'] . "<br>" . $row['jdistro1'] . " (km) dari pabrik"));
  $array2 = array_filter(array((float)$row['lat2'], (float)$row['lng2'], $row['distro2'] . "<br>" . $row['jdistro2'] . " (km) dari pabrik"));
  $array3 = array_filter(array((float)$row['lat3'], (float)$row['lng3'], $row['distro3'] . "<br>" . $row['jdistro3'] . " (km) dari pabrik"));
...
<script>
  ...
  var nama = 'PT Pancuran Kaapit Sendang';
