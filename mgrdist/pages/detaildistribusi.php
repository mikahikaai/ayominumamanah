  ...
  <div class="card">
    ...
    <div class="card-body">
      <form action="" method="post">
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <input id='datetimepicker1' type='text' class='form-control' data-td-target='#datetimepicker1' placeholder="dd/mm/yyyy hh:mm" name="jam_datang" value="<?= date('d/m/Y H:i:s', strtotime($row['jam_datang'])); ?>" readonly>
            </div>
          </div>
        </div>
        <div class="form-group">
        ...
        <a href="?page=detailpengajuan&idk=<?= $_GET['idk'] ?>" class="btn btn-danger btn-sm float-right">
